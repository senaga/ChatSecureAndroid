 ...
 * Original file: /Users/marcelo/dev/android/ChatSecureAndroid_ulife/chatSecure/src/main/aidl/info/guardianproject/otr/app/im/IChatSession.aidl
 */
...
{
data.enforceInterface(DESCRIPTOR);
info.guardianproject.otr.app.im.IDataListener _arg0;
_arg0 = info.guardianproject.otr.app.im.IDataListener.Stub.asInterface(data.readStrongBinder());
...
/**
    ...
    */
@Override public void setDataListener(info.guardianproject.otr.app.im.IDataListener dataListener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
    * set class for handling incoming data transfers
    */
public void setDataListener(info.guardianproject.otr.app.im.IDataListener dataListener) throws android.os.RemoteException;
/**
    * respond to incoming data request
    */
