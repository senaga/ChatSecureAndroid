 ...
 * Original file: /Users/marcelo/dev/android/ChatSecureAndroid_ulife/chatSecure/src/main/aidl/info/guardianproject/otr/app/im/plugin/IPasswordDigest.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements info.guardianproject.otr.app.im.plugin.IPasswordDigest
{
private static final java.lang.String DESCRIPTOR = "info.guardianproject.otr.app.im.plugin.IPasswordDigest";
...
/**
 * Cast an IBinder object into an info.guardianproject.otr.app.im.plugin.IPasswordDigest interface,
 * generating a proxy if needed.
 */
public static info.guardianproject.otr.app.im.plugin.IPasswordDigest asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof info.guardianproject.otr.app.im.plugin.IPasswordDigest))) {
return ((info.guardianproject.otr.app.im.plugin.IPasswordDigest)iin);
}
return new info.guardianproject.otr.app.im.plugin.IPasswordDigest.Stub.Proxy(obj);
}
...
private static class Proxy implements info.guardianproject.otr.app.im.plugin.IPasswordDigest
{
