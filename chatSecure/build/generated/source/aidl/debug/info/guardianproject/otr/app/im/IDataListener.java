 ...
 * Original file: /Users/marcelo/dev/android/ChatSecureAndroid_ulife/chatSecure/src/main/aidl/info/guardianproject/otr/app/im/IDataListener.aidl
 */
package info.guardianproject.otr.app.im;
public interface IDataListener extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements info.guardianproject.otr.app.im.IDataListener
{
private static final java.lang.String DESCRIPTOR = "info.guardianproject.otr.app.im.IDataListener";
...
/**
 * Cast an IBinder object into an info.guardianproject.otr.app.im.IDataListener interface,
 * generating a proxy if needed.
 */
public static info.guardianproject.otr.app.im.IDataListener asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof info.guardianproject.otr.app.im.IDataListener))) {
return ((info.guardianproject.otr.app.im.IDataListener)iin);
}
return new info.guardianproject.otr.app.im.IDataListener.Stub.Proxy(obj);
}
...
private static class Proxy implements info.guardianproject.otr.app.im.IDataListener
{
